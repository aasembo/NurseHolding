...
return [ 
    'App' => [
        'fullBaseUrl' => 'https://prod.dataratiba.com',
        'authDriver' => 'okta',
        'okta' => [
            ...
            'redirectUri' => 'https://prod.dataratiba.com/auth/callback/',
            'postLogoutRedirectUri' => 'https://prod.dataratiba.com/logout/complete',
