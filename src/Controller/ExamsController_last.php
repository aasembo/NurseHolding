            ...
            try {
                ...
                if ( $this->hasCsvColumn( $headerMap, 'Exam' ) ) {
                    $examData = [
                        ...
                        'imaging_room_id' => $this->getCsvValue( $row, $headerMap, 'imaging_room_id' ),
                        'technician_id' => $this->getCsvValue( $row, $headerMap, 'technician_id' ),
                        'specialist_id' => $this->getCsvValue( $row, $headerMap, 'specialist_id' ),
                    ];
                ...
                if ($this->hasCsvColumn($headerMap, 'Scheduled Time') || $this->hasCsvColumn($headerMap, 'Completed Time')) {
                    $startTime = $this->getCsvValue($row, $headerMap, 'Begin Time');
                    $endTime = $this->getCsvValue($row, $headerMap, 'Completed Time');
