...
class NursingInterventionController extends AppController
{
    ...
    {
        $nursingIntervention = $this->NursingIntervention->get($id, contain: ['Patients']);
        $this->set(compact('nursingIntervention'));
    }
    ...
    public function add()
    {
        ...
        $patients = $this->NursingIntervention->Patients->find('list', limit: 200)->all();
        $this->set(compact('nursingIntervention', 'patients'));
    }
