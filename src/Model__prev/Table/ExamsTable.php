 ...
 * @property \App\Model\Table\ScheduledTimeTable&\Cake\ORM\Association\BelongsTo $ScheduledTimes
 ...
 * @property \App\Model\Table\ExamStatusUpdatesTable&\Cake\ORM\Association\HasMany $ExamStatusUpdates
 * @property \App\Model\Table\ExamTimingsTable&\Cake\ORM\Association\HasMany $ExamTimings
 * @property \App\Model\Table\PatientLogsTable&\Cake\ORM\Association\HasMany $PatientLogs
...
class ExamsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('ScheduledTimes', [
            'foreignKey' => 'scheduled_time_id',
            'className' => 'ScheduledTime',
            'joinType' => 'LEFT'
        ]);
        ...
        $this->hasMany('ExamStatusUpdates', [
            'foreignKey' => 'exam_id',
        ]);
        $this->hasMany('ExamTimings', [
            'foreignKey' => 'exam_id',
        ]);
        $this->hasMany('PatientLogs', [
            'foreignKey' => 'exam_id',
        ]);
        ...
        $this->hasMany('Sedations', [
            'foreignKey' => 'exam_id', // Ensuring correct association
            'dependent' => true, // This ensures sedations get deleted if the exam is deleted
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->allowEmptyString('technician_id');

        $validator
            ->integer('specialist_id')
            ->allowEmptyString('specialist_id');
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->existsIn(['scheduled_time_id'], 'ScheduledTimes'), ['errorField' => 'scheduled_time_id']);
