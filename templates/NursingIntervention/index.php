...
<div class="nursingIntervention index content">
    <?= $this->Html->link(__('New Nursing Intervention'), ['action' => 'add'], ['class' => 'themebtn']) ?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $nursingIntervention->hasValue('patient') ? $this->Html->link($nursingIntervention->patient->FirstName, ['controller' => 'Patients', 'action' => 'view', $nursingIntervention->patient->id]) : '' ?></td>
